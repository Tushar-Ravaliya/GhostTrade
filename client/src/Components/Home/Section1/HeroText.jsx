...
const HeroText = () => {
  return (
    <>
      <div className="py-8 my-16 flex flex-col gap-6 text-white uppercase text-center font-frijole">
        ...
        <div className="text-sm tracking-widest font-normal max-w-2xl text-white/50 mx-auto px-6">
