    ...
    <div className='min-h-screen w-full'>
      ...
      <div className='text-white px-5 md:px-10 py-6 w-full max-w-9xl'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-6 md:gap-10 border-b border-gray-800 pb-8'>
          <img className='rounded-full hover:animate-spin h-24 w-24 md:h-28 md:w-28 object-cover border-2 border-white p-1' src="Images/profileImg.jpeg" alt="Profile" />
        ...
        <div className='flex flex-col gap-2 text-white font-semibold py-8'>
          <h3>Username</h3>
          <input type="text" className='w-full border-gray-700 text-gray-400 p-2.5 border-b focus:border-green-700 focus:outline-none bg-transparent' placeholder='Keyuri Jethwa' />

          <h3 className='mt-5'>Email</h3>
          <input type="text" className='w-full border-gray-700 text-gray-400 p-2.5 border-b focus:border-green-700 focus:outline-none bg-transparent' placeholder='keyuri@gmail.com' />
        ...
        <div className='flex flex-col gap-2 text-gray-400 font-semibold py-8 border-t border-gray-800'>
          <h2 className='font-bold text-2xl md:text-3xl text-white mb-4'>Password Change</h2>

          <h3 className='mt-3'>Current Password</h3>
          <input type="password" ocean className='w-full border-gray-600 text-gray-400 p-2.5 border-b focus:border-green-700 focus:outline-none bg-transparent' placeholder='Current Password' />

          <h3 className='mt-5'>New Password</h3>
          <input type="password" ocean className='w-full border-gray-600 text-gray-400 p-2.5 border-b focus:border-green-700 focus:outline-none bg-transparent' placeholder='New Password' />

          <h3 className='mt-5'>Confirm Password</h3>
          <input type="Password" ocean className='w-full border-gray-600 text-gray-400 p-2.5 border-b focus:border-green-700 focus:outline-none bg-transparent' placeholder='Confirm Password' />
